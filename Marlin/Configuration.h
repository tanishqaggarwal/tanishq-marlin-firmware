...
#define STRING_CONFIG_H_AUTHOR "Tanishq Aggarwal" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Aggarwal 3D Printer"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "b83d5c92-4b87-48a8-8cfb-56d0d293518b"
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.25  // Z probe to nozzle Z offset: -below (always!)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402,78.7402,4020,836}  // default steps per unit for Ultimaker
